...
const styleNavMobileActive = `absolute translate-y-14 -translate-x-5 bg-primaryColor bg-opacity-50 z-1 
        `;

export const ModalMobile = ({ isOpen }: ModalMobileProps) => {
  return (
    <nav
      className={` top-0 shadow-md transition-transform duration-1000
      ease-in-out ${isOpen ? styleNavMobileActive : styleNavMobileDisable}`}
    >
